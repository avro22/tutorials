...
1. Check how much space you have on DICE. **You will need at least 3GB**.
    1. `freespace`
...
just delete your environment and start again. Execute `conda remove --name py3rss
...
the [GitHub repo](https://github.com/.....) directly by clicking the green button and downloading the zip.

### wget: command not found
You do not have wget installed! Either install it, download from
the [GitHub repo](https://github.com/.....) directly by clicking the green button and download the zip, or try using another program like curl e.g. `curl -LOk https://github.com/....../archive/master.zip`
